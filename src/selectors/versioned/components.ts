...
export const versionedComponents2 = {
  Breadcrumbs: {
    breadcrumb: {
  ...
  TransformTab: {
    ...
    transformationEditor: (name: string) =>
      `data-testid Transformation editor ${name}`,
    transformationEditorDebugger: (name: string) =>
      `data-testid Transformation editor debugger ${name}`,
  },
  Transforms: {
  ...
  OptionsGroup: {
    group: (title?: string) =>
      title ? `Options group ${title}` : 'Options group',
    toggle: (title?: string) =>
      title ? `Options group ${title} toggle` : 'Options group toggle',
  },
  PluginVisualization: {
  ...
  Search: {
    ...
    collapseFolder: (sectionId: string) =>
      `data-testid Collapse folder ${sectionId}`,
    expandFolder: (sectionId: string) =>
      `data-testid Expand folder ${sectionId}`,
    dashboardCard: (item: string) => `data-testid Search card ${item}`,
    folderHeader: (folderName: string) =>
      `data-testid Folder header ${folderName}`,
    folderContent: (folderName: string) =>
      `data-testid Folder content ${folderName}`,
...
export const versionedComponents: E2ESelectors<typeof versionedComponents2> =
  versionedComponents2;
